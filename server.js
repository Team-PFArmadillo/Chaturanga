...
//   console.log('In the post message block!');
//   const myData = new MessageThread(req.body);
//   myData.save()
//   .then(msg => {
//     res.send('msg saved to the database');
//   })
//   .catch(err => {
//     res.status(400).send('Whoopsies! Unable to save to the database.');
//   });
// });
